...
for subject in range(10):
    for position in range(18):
        ...
        print("Running simulation for subject " + str(subject) + " position " + str(position))
        ...
        while True:
            ...
            tau_idc = idc_calculate(q1, q21, q31, q4, q5, upper_arm_new, forearm_new, femur_to_humeris_new, pelvis_to_femur_new)
        ...
        if reason == "Maximum simulation time elapsed":
            error_run.append({"subject": subject, "position": position})
            ...
            log_all.append([subject, position, avg_positions[0], avg_positions[1], avg_positions[2], avg_positions[3], avg_positions[4], avg_torques[0], avg_torques[1], avg_torques[2]])
...
with open(results_path, "w", newline="") as file:
    writer = csv.writer(file)
    writer.writerow(["Subject", "Position", "q1", "q21", "q31", "q4", "q5", "t1", "t2", "t3"])
