...
scatter3(shoulder_positions_adjusted(:,1), ...
         ...
         50, 'r', 'filled', 'DisplayName', 'Actual Position');
...
scatter3(shoulder_positions_calculated(:,1), ...
         ...
         50, 'bo', 'DisplayName', 'Calculated Position');
...
scatter3(shoulder_positions_calculated_v2(:,1), ...
         ...
         50, 'g^', 'DisplayName', 'Calculated Position v2');
...
subplot(3,1,1);
hold on; grid on;
scatter(1:num_positions, shoulder_positions_adjusted(:,1), 50, 'r', 'filled', 'DisplayName', 'Actual X');
scatter(1:num_positions, shoulder_positions_calculated(:,1), 50, 'bo', 'DisplayName', 'Calculated X');
scatter(1:num_positions, shoulder_positions_calculated_v2(:,1), 50, 'g^', 'DisplayName', 'Calculated X v2');
ylabel('X (meters)');
...
subplot(3,1,2);
hold on; grid on;
scatter(1:num_positions, shoulder_positions_adjusted(:,2), 50, 'r', 'filled', 'DisplayName', 'Actual Y');
scatter(1:num_positions, shoulder_positions_calculated(:,2), 50, 'bo', 'DisplayName', 'Calculated Y');
scatter(1:num_positions, shoulder_positions_calculated_v2(:,2), 50, 'g^', 'DisplayName', 'Calculated Y v2');
ylabel('Y (meters)');
...
subplot(3,1,3);
hold on; grid on;
scatter(1:num_positions, shoulder_positions_adjusted(:,3), 50, 'r', 'filled', 'DisplayName', 'Actual Z');
scatter(1:num_positions, shoulder_positions_calculated(:,3), 50, 'bo', 'DisplayName', 'Calculated Z');
scatter(1:num_positions, shoulder_positions_calculated_v2(:,3), 50, 'g^', 'DisplayName', 'Calculated Z v2');
ylabel('Z (meters)');
