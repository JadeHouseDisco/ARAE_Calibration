...
for a = 1:numActivities
    ...
    for m = 1:numMuscles
        ...
        set(gca, 'XTick', 1:numModes, 'XTickLabel', collectionModes);
        ylabel('Mean MAV');
...
sgtitle('Mean Change in MAV: Nominal/Personalised vs Norob');
...
sgtitle('Mean Change in Median Frequency (MDF): Nominal/Personalised vs Norob');