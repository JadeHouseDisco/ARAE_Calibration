...
ylabel('Values');
title('Comparison of Nominal and Personalized Immesurable Anthropometric Data');
legend('Nominal', 'Personalized', 'Location', 'NorthEast');
...
for i = 1:num_torque_components
    ...
    hold on;
    plot(1:num_positions, theoreticalTorque(:, i), 'r--s', 'LineWidth', 1.5, 'DisplayName', 'Nominal Torque');
    plot(1:num_positions, theoreticalTorqueAdjusted(:, i), 'g-.d', 'LineWidth', 1.5, 'DisplayName', 'Personalized Torque');
